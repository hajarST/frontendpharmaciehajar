...
import './Accueil.css'; // Import custom CSS styles
  ...
  return (
    <div  style={{ width: "100%" }}>
      <div className="container">
        <h1 className="mt-4 mb-4 text-center" style={{color: "blue"}}>GeoPharma</h1>
        <hr />
        <br />
        <br />
        <div className="row">
          <div className="col-sm-4">
            <Card className="mb-3 bg-primary shadow fade-in">
              <Card.Body>
          ...
          {/* <div className="col-sm-4">
            <Card className="mb-3 bg-success shadow fade-in">
              <Card.Body>
                <div className="d-flex align-items-center">
                  <Icon icon={medkit} className="me-3" size={24} />
                  <div>
